  ...
  render () {
    ...
    const trackTabTitleContent = (
      <div className='track-tab-title'>
        ...
        <Tooltip title={visibleTitle} placement='bottom'>
          <Button className='ml-auto' icon size='sm' type='tertiary' variant='text' onClick={(e) => { e.stopPropagation(); this.props.handleLayerVisibleChange([this.props.dataSourceId], !this.props.locationLayerVisible, 1) }} aria-label={visibleTitle}>
    ...
    const trackLineTabTitleContent = (
      <div className='track-tab-title' >
        ...
        <Tooltip title={visibleTitle} placement='bottom'>
          <Button className='ml-auto' icon size='sm' type='tertiary' variant='text' onClick={(e) => { e.stopPropagation(); this.props.handleLayerVisibleChange([this.props.lineDataSourceId], !this.props.pathLayerVisible, 2) }} aria-label={visibleTitle}>
