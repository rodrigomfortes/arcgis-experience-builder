...
const getWidgetGlobalStyle = (dividerColor: string, handleColor: string, widgetId: string) => css`
  .esri-ui .exb-swipe-${widgetId},.esri-component {
    pointer-events: none !important;
  }
  .exb-swipe-${widgetId} {
    .arcgis-swipe__divider {
      --calcite-color-background: ${dividerColor} !important;
    }
    .arcgis-swipe__handle {
      --calcite-color-background: ${handleColor} !important;
    }
  }
...
const Widget = (props: AllWidgetProps<IMConfig>) => {
  ...
  return (
    <div className='jimu-widget jimu-widget-swipe' css={getStyle}>
