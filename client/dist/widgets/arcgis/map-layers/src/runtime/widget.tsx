/** @jsx jsx */
import { AppMode, React, jsx, type AllWidgetProps, DataSourceComponent, MutableStoreManager, isKeyboardMode, focusElementInKeyboardMode, type MapDataSource, DataSourceTypes, type IMState, ExBAddedJSAPIProperties, semver, getAppStore, appActions } from 'jimu-core'
import {
...
import { WidgetPlaceholder, Popper, defaultMessages as jimuDefaultMessages, Loading, getFocusableElements, LoadingType } from 'jimu-ui'
...
export class Widget extends React.PureComponent<WidgetProps & ExtraProps, WidgetState> {
  ...
  defineLayerListActionsGenerator = (isTableList = false) => {
    return (event) => {
      ...
      if (!dataActionEnabled && nativeActionCount <= 1 && !actionGroups[TRANSPARENCY_ACTION_INDEX] && !actionGroups[RANGE_ACTION_INDEX] && !actionGroups[SYMBOL_ACTION_INDEX]) {
