/** @jsx jsx */
import { React, jsx, css, classNames, AppMode, type IMState, ReactRedux, loadArcGISJSAPIModules, hooks, type IMThemeVariables, focusElementInKeyboardMode } from 'jimu-core'
      ...
      {activeButton === '' && <div aria-label={translate('selectToStart')} className='esri-widget esri-widget--panel' role='presentation'>
        <div className='esri-measurement-widget-content'>
          <section className='esri-measurement-widget-content__hint'>
            <p id='selectToStart' className='esri-measurement-widget-content__hint-text'>{translate('selectToStart')}</p>
          </section>
        </div>
      </div>}
