    ...
    ? <AnalysisList
        ...
        renderOverrideItemCommands={(actionData, refComponent) => {
          ...
          return <Dropdown useKeyUpEvent>
            ...
            {!statusCancellable
              ? <DropdownMenu onKeyUp={(e) => { e.stopPropagation() }}>
      ...
      />
    : <div id={placeholderId} className='d-flex align-items-center justify-content-center' css={css`height: 100%; flex-direction: column; padding: 0 20%; color: var(--ref-palette-neutral-1000); text-align: center`}>
