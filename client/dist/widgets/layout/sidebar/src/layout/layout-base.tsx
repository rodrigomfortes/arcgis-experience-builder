...
import { syncWidgetHiddenState } from './util'
...
export abstract class BaseSidebarLayout extends React.PureComponent<SidebarProps, State> {
  ...
  componentDidMount (): void {
    ...
    if (!this.props.sidebarVisible) {
      // set hidden state if sidebar is not visible at start
      syncWidgetHiddenState(this.props.widgetId, false)
    }
  }
  ...
  componentDidUpdate (prevProps: SidebarProps): void {
    ...
    if (prevProps.sidebarVisible !== this.props.sidebarVisible) {
      syncWidgetHiddenState(this.props.widgetId, this.props.sidebarVisible)
    }
  }
