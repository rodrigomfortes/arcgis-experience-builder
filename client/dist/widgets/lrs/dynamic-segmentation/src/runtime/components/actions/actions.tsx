...
import { type AttributeSetParam, DisplayType, type MessageProp } from '../../../config'
...
export function Actions (props: ActionsProps) {
  const { intl, routeId, allowMerge, widgetId, jimuMapView, highlightColor, lrsLayers, networkDS, networkInfo, dynSegFeatureLayer, onSave, attributeSet } = props
