/** @jsx jsx */
import { React, jsx, type IMThemeVariables, css, hooks, defaultMessages as jimuCoreMessages, focusElementInKeyboardMode } from 'jimu-core'
...
const SearchTool = (props: Props) => {
  ...
  const searchPopupRef = React.useRef<HTMLButtonElement>()
