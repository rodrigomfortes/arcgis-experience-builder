/** @jsx jsx */
import { React, jsx, css, hooks, type ClauseValuePair, type QueriableDataSource, type DataRecord, type FeatureLayerDataSource } from 'jimu-core'
import {
...
const TableToolList = (props: TableToolListProps) => {
  ...
  const { enableSearch = false, searchFields = [], enableSelect, enableRefresh, enableShowHideColumn = true } = curLayerConfig
  ...
  }, [tableShowColumns, tableColumnsVisibleFields])
