  ...
  renderCardEditor = () => {
    ...
    const regularEditor = (
      <div
        ...
        key={Status.Default}
      >
        <div className='w-100, h-100 animation-list card-editor-con' style={regularMergedStyle}>
    ...
    const hoverEditor = (
      <div
        ...
        key={Status.Hover}
      >
        <div className='w-100, h-100 animation-list position-relative card-editor-con' style={hoverMergedStyle}>
          <AnimationContext.Provider
            value={{
              setting: transitionInfo?.oneByOneEffect || null,
              playId: hoverPlayId,
