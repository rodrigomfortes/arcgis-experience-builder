...
import { Select, type ImageParam, type CropParam, ImageFillMode, Slider, NumericInput, Tabs, Tab, Tooltip, imageUtils, Switch } from 'jimu-ui'
      ...
      <div css={this.getStyle(this.props.theme)} className='jimu-widget'>
        <div className='widget-setting-image'>
          ...
          <SettingSection>
            ...
            {functionConfig?.dynamicUrlType !== DynamicUrlType.Symbol &&<SettingRow tag='label' label={this.formatMessage('imageViewer')} aria-label={this.formatMessage('imageViewer')}>
              <Switch
                checked={!!functionConfig.imageViewer}
