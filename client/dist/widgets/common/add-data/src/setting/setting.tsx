...
import { Button, defaultMessages as jimuUIMessages, MultiSelect, MultiSelectItem, Switch, TextInput } from 'jimu-ui'
...
import { useCuratedIndex, useDefaultLabel, useItemCategoriesInfo, useNeedHideItemCategories } from '../utils'
