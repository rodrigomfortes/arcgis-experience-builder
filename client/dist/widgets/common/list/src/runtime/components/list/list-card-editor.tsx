...
> {
  ...
  render () {
    ...
    const bgStyle = initBackgroundStyle(cardConfigs[builderStatus].backgroundStyle, dynamicStyleOfCard?.[builderStatus])
    ...
    return (
      <ListGroupItem
        ...
        className={classNames('surface-1', `list-card-${id}`)}
