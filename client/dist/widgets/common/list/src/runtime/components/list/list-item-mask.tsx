/** @jsx jsx */
import { jsx, React, polished, css, classNames, AppMode, hooks, ReactRedux, type IMState } from 'jimu-core'
...
const MaskOfListItem = (props: Props) => {
  ...
  const STYLE = css`
    .list-item-mask {
      ...
      right: 0;
      z-index: 10;
      background-color: ${polished.rgba(theme.ref.palette.black, 0.5)};
    }
    .space-mask {
      &::before, &::after{
        display: block;
