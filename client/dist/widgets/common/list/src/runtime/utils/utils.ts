...
import type { UseDataSource, LayoutItemConstructorProps, BrowserSizeMode, DataSource, RepeatedDataSource, BoundingBox, QueriableDataSource, IMState, AllWidgetProps, IMDynamicStyle } from 'jimu-core'
...
export function initBackgroundStyle (cardBackgroundStyle: IMCardBackgroundStyle, dynamicStyleOfCard?: IMDynamicStyle) {
