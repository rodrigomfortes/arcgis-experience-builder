/** @jsx jsx */
import { jsx, React, AppMode, hooks, classNames, Immutable, BrowserSizeMode, css, polished, focusElementInKeyboardMode, LayoutType } from 'jimu-core'
...
const ListTemplateSelector = (props: Props) => {
  ...
  }, [settingPanelChange, updateStartButtonPosition])
