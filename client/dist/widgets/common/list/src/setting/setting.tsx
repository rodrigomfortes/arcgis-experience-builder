...
export default class Setting extends React.PureComponent<AllWidgetSettingProps<IMConfig> & ExtraProps & CustomProps, State> {
  ...
  render () {
    const { config, showCardSetting, browserSizeMode, widgetRect, builderStatus, useDataSources, layouts, selectionIsInSelf, appMode, id, appConfig, useDataSourcesEnabled, layoutInfo, parentSize, settingPanelChange, theme } = this.props
    const { datasource } = this.state
    return (
      <div
