...
export const ByGroupData = (props: ByGroupDataProps): React.ReactElement => {
  ...
  const temporalBinning = (propSeries?.[0] as unknown as WebChartLineChartSeries)?.temporalBinning as WebChartFixedDateBinning
  ...
  const handleBinTemporalDataChange = async (binTemporalData: boolean): Promise<void> => {
    if (binTemporalData) {
      try {
        ...
        const temporalBinning: WebChartFixedDateBinning = { ...DefaultTemporalBinning, unit, nullPolicy }
