...
import { getSeriesType, WebChartTypes, type WebChartPieChartSeries, type WebChartPieChartLegend, type WebChartFixedDateBinning, WebChartFixedDateBinningUnits } from 'jimu-ui/advanced/chart'
...
const EsriTimeUnitsUpgradeMapping = {
  'esriTimeUnitsSeconds': WebChartFixedDateBinningUnits.Second,
  'esriTimeUnitsMinutes': WebChartFixedDateBinningUnits.Minute,
  'esriTimeUnitsHours': WebChartFixedDateBinningUnits.Hour,
  'esriTimeUnitsDays': WebChartFixedDateBinningUnits.Day,
  'esriTimeUnitsWeeks': WebChartFixedDateBinningUnits.Week,
  'esriTimeUnitsMonths': WebChartFixedDateBinningUnits.Month,
  'esriTimeUnitsYears': WebChartFixedDateBinningUnits.Year
}
    ...
    upgrader: (oldConfig: IMConfig) => {
      ...
      if ((seriesType === 'lineSeries' || seriesType === 'barSeries') && categoryType === CategoryType.ByGroup && binTemporalData) {
        series = series.map((serie) => {
          ...
          const temporalBinning: WebChartFixedDateBinning = { type: 'fixedDateBased' }
