...
import { type CategoryFormatOptions, type DateTimeFormatOptions, getDefaultCategoryFormat, type WebChartLineChartSeries, getSplitByValue, WebChartSortOrderKinds, getSeriesType, type WebChartPieChartSeries, WebChartTemporalBinningUnits, getSplitByField, type WebChartBarChartSeries, type WebChartScatterplotSeries, type WebChartHistogramSeries, WebChartTimeAggregationTypes, WebChartNullPolicyTypes, type WebChartGaugeSeries, type ChartTypes, type ISimpleLineSymbol, type ISimpleFillSymbol, WebChartTypes, type NumberFormatOptions, type WebChartFixedDateBinning, WebChartTemporalBinningTypes } from 'jimu-ui/advanced/chart'
...
export const DefaultTemporalBinning: WebChartFixedDateBinning = {
  type: WebChartTemporalBinningTypes.FixedDateBased,
  size: 1,
  unit: WebChartTemporalBinningUnits.Month,
...
const getSeriesProps = (serie: ImmutableObject<WebChartSeries>, query: IMFeatureLayerQueryParams) => {
  ...
  const temporalBinning = (serie as unknown as WebChartLineChartSeries)?.temporalBinning as WebChartFixedDateBinning
...
export interface SplitBySerieProps {
  ...
  temporalBinning: WebChartFixedDateBinning
}
