...
function useTreeNode(nodeItem: NodeRepositoryItem): UseTreeNodeContextType {
  ...
  const [documentChildren, setDocumentChildren] = useState<DocumentRepositoryItem[]>([])
  ...
  useEffect(
    ...
    [expandedOnce, getChildren, nodeChildrenAlreadyLoaded, nodeItem, useDocumentsReady]
  )
  ...
  const useTreeNodeReturn: UseTreeNodeContextType = useMemo(
    ...
    [accessError, documentChildren, expanded, loading, nodeChildren, onToggleExpanded]
  )
