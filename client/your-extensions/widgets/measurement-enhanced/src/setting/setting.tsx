...
const Setting = (props: AllWidgetSettingProps<any>) => {
  ...
  const onSnapToggle = (value: boolean) => {
    props.onSettingChange({
      id,
      config: {
        ...config,
  ...
  return (
    <div className="widget-setting-demo" style={{ padding: '16px' }}>
      ...
      <h4 style={{ marginBottom: '10px' }}>Snap Angular (Ângulos Fixos)</h4>
      <p style={{ fontSize: '12px', color: '#666', marginBottom: '12px' }}>
        Habilita o snap para forçar as linhas de medição a seguir ângulos predefinidos: 90°, 45° e 30°. 
        Facilita o desenho ortogonal e angular.
      </p>

      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
        <Checkbox
          checked={!!config?.angularSnap}
          onChange={e => onSnapToggle(e.target.checked)}
        />
        <span style={{ marginLeft: '8px' }}>Trava o cursor nos ângulos 90°, 45°, 30°</span>
      </div>
