        ...
        if (event.state === "active" || event.state === "complete") {
          ...
          if (idx >= 0) {
            ...
            if (event.state === "active") {
              let liveValue = "";
              if (editedGraphic.geometry.type === "polyline") {
                liveValue = formatLastSegmentDistance(editedGraphic.geometry as __esri.Polyline);
              } else if (editedGraphic.geometry.type === "polygon") {
                liveValue = formatLiveMeasurement(editedGraphic.geometry);
              }
            ...
            // Atualiza labels dos segmentos para refletir edição
